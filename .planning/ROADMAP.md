...
- [ ] **Phase 1: Foundation** - apps/admin 스캐폴딩, 인증 게이트, i18n 설정, Vercel 배포
- [ ] **Phase 2: Content List Views** - 4개 콘텐츠 타입 목록, 검색·필터·페이지네이션, 대시보드
- [ ] **Phase 3: Content Editing & Review Workflow** - 편집 폼, 승인/반려 워크플로우, 감사 로그
...
Plans:
- [ ] 01-01-PLAN.md — Scaffold apps/admin with configs, Supabase clients, i18n infra, root layout, test scaffolds
