    ...
    <div className="border-t bg-background safe-area-bottom">
      ...
      <div className="flex items-end gap-2 p-3">
        ...
        <textarea
          ...
          disabled={disabled}
          rows={1}
          className="font-jp border-input bg-secondary/50 max-h-24 min-h-[40px] flex-1 resize-none rounded-xl border px-3 py-2.5 text-sm outline-none focus-visible:ring-2 focus-visible:ring-primary/30 disabled:opacity-50"
        />
