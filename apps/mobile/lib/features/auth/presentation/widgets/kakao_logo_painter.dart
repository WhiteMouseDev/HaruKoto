...
class KakaoLogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path()
      ...
      ..cubicTo(6.22 * s, 17.22 * s, 5.51 * s, 19.81 * s, 5.48 * s, 20.01 * s)
      ..cubicTo(5.48 * s, 20.01 * s, 5.46 * s, 20.09 * s, 5.52 * s, 20.12 * s)
      ..cubicTo(5.58 * s, 20.15 * s, 5.65 * s, 20.13 * s, 5.65 * s, 20.13 * s)
      ..cubicTo(5.82 * s, 20.11 * s, 8.8 * s, 18.05 * s, 9.29 * s, 17.7 * s)
      ..cubicTo(10.17 * s, 17.83 * s, 11.08 * s, 17.9 * s, 12 * s, 17.9 * s)
