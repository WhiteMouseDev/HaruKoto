        ...
        history.append(
            {
                ...
                "category": scenario.category.value if scenario else None,
                "difficulty": scenario.difficulty.value if scenario else None,
                "characterName": character.name if character else None,
                "characterEmoji": character.avatar_emoji if character else None,
    ...
    return [
        {
            ...
            "gender": c.gender,
            "ageDescription": c.age_description,
