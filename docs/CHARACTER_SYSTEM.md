...
여성 유저를 주요 타겟으로 매력적인 캐릭터 라인업을 제공하여 학습 동기를 극대화한다. 각 JLPT 레벨 단계마다 남녀 캐릭터 쌍을 배치하고, 레벨업 시 새로운 캐릭터가 해금되어 지속적인 학습 동기를 부여한다.
...
| **초급** | N4 도달 | 카이토 (かいと) | 유키 (ゆき) | です・ます (정중체) |
| **중급** | N3 도달 | 렌 (れん) | 미오 (みお) | 비즈니스 일본어 |
| **고급** | N2 도달 | 리쿠 (りく) | 아오이 (あおい) | 敬語 (경어) |
