...
> 상세 설계: `docs/PAYMENT_SYSTEM.md`

### 4.1 무료 (Free Tier)

- JLPT 단어/문법 퀴즈 (전 레벨)
- 히라가나/가타카나 학습 (전체)
- 기본 게이미피케이션 (포인트, 스트릭, 레벨, 데일리 미션, 업적)
- 학습 진도 대시보드
- 오답 노트 (기본)
- AI 회화 연습 (하루 30분)
...
- Free 전체 기능 포함
- AI 회화 연습 (무제한, 시간 제한 없음)
- 오답 노트 + 상세 분석 (AI 약점 분석, 관련 문법 추천)
- 광고 제거 (추후 무료 티어에 광고 추가 시)

### 4.3 가격

- 월 구독: ₩7,900
- 연 구독: ₩71,000 (월 ₩5,917, 25% 할인)
- 무료 체험: 7일 프리미엄 전체 기능 체험
- PG: 토스페이먼츠 (웹 결제)
