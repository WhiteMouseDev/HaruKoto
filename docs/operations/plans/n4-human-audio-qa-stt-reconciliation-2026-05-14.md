...
| P1 STT-only items | 62 |
| Canonical text matches | 3 |
| Near Japanese matches | 11 |
| Mixed/Korean prompt STT-unreliable | 40 |
| Lexical-risk Japanese mismatches | 8 |
...
| Bucket | Target | Source text | STT transcript | Similarity | Signals | Recommended action | Audio |
|---|---|---|---|---:|---|---|---|
| LEXICAL_RISK | HN4-001 script:3 | 分かりました。丁寧に確認します。 | わかりました。定時に確認します。 | 0.759 | TRANSCRIPTION_TEXT_MISMATCH:わかりました。定時に確認します。 | listen carefully before PASS; prefer FLAG when the source text is not clearly spoken | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/b544d1f5-8089-45f8-b3d9-6428b60a0ece/script-line-3.mp3) |
| LEXICAL_RISK | HN4-003 script:1 | じゃあ、会議に間に合わないかもしれませんね。 | じゃあ、会計に値に合わないかもしれないですね。 | 0.732 | TRANSCRIPTION_TEXT_MISMATCH:じゃあ、会計に値に合わないかもしれないですね。 | listen carefully before PASS; prefer FLAG when the source text is not clearly spoken | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/82d7334e-c4c4-4102-86ea-7be9b3218bce/script-line-1.mp3) |
| LEXICAL_RISK | HN4-004 script:3 | 諦めないで、急いで行きましょう。 | 始めないで競いに行きましょう | 0.786 | TRANSCRIPTION_TEXT_MISMATCH:始めないで競いに行きましょう | listen carefully before PASS; prefer FLAG when the source text is not clearly spoken | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/8368ee77-eeb8-48b2-9c81-2cfd597e5f7a/script-line-3.mp3) |
| LEXICAL_RISK | HN4-006 script:0 | 湖の深さを地図で確認しました。 | 骨の傘を実で確認しました。 | 0.692 | TRANSCRIPTION_TEXT_MISMATCH:骨の傘を実で確認しました。 | listen carefully before PASS; prefer FLAG when the source text is not clearly spoken | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/94d8d321-17c6-4fa1-8c50-af29c08e9c22/script-line-0.mp3) |
| LEXICAL_RISK | HN4-006 script:2 | はい。線の太さや細さも見られます。 | はい。不当操作や操作もみられます。 | 0.533 | TRANSCRIPTION_TEXT_MISMATCH:はい。不当操作や操作もみられます。 | listen carefully before PASS; prefer FLAG when the source text is not clearly spoken | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/94d8d321-17c6-4fa1-8c50-af29c08e9c22/script-line-2.mp3) |
| LEXICAL_RISK | HN4-008 script:0 | 返事が遅れてすみません。 | 半時が遅れてすみません。 | 0.783 | TRANSCRIPTION_TEXT_MISMATCH:半時が遅れてすみません。 | listen carefully before PASS; prefer FLAG when the source text is not clearly spoken | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/78e8b581-c81d-4465-b49d-cf0e4b49db4a/script-line-0.mp3) |
| LEXICAL_RISK | HN4-010 script:3 | 荷物が届くと、メールが来ます。 | 何か届くとメールが来ます。 | 0.800 | TRANSCRIPTION_TEXT_MISMATCH:何か届くとメールが来ます。 | listen carefully before PASS; prefer FLAG when the source text is not clearly spoken | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/1445c28c-bd0c-4c0a-b8f7-2708c51acca7/script-line-3.mp3) |
| LEXICAL_RISK | HN4-011 script:1 | 厚い紙と薄い紙がありますね。 | 石と薄い石があります。 | 0.696 | TRANSCRIPTION_TEXT_MISMATCH:石と薄い石があります。 | listen carefully before PASS; prefer FLAG when the source text is not clearly spoken | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/03cfdb15-c916-450c-8168-9052f3e754aa/script-line-1.mp3) |
...
| Bucket | Target | Source text | STT transcript | Similarity | Signals | Recommended action | Audio |
|---|---|---|---|---:|---|---|---|
| CANONICAL_MATCH | HN4-002 script:1 | 心配ですね。今日は早く寝たほうがいいです。 | 心配ですね。今日は早く寝た方がいいです。 | 1.000 | TRANSCRIPTION_TEXT_MISMATCH:心配ですね。今日は早く寝た方がいいです。 | candidate for delegated PASS after optional spot listen; keep native-speaker boundary in notes | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/89433566-b321-4f99-ac20-9ffb87e69d6b/script-line-1.mp3) |
| CANONICAL_MATCH | HN4-002 script:3 | 熱があれば、医者に相談したほうが安心です。 | 熱があれば医者に相談した方が安心です。 | 1.000 | TRANSCRIPTION_TEXT_MISMATCH:熱があれば医者に相談した方が安心です。 | candidate for delegated PASS after optional spot listen; keep native-speaker boundary in notes | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/89433566-b321-4f99-ac20-9ffb87e69d6b/script-line-3.mp3) |
| CANONICAL_MATCH | HN4-010 script:2 | はい。自然な結果を言うときに使います。 | はい、自然な結果を言う時に使います。 | 1.000 | TRANSCRIPTION_TEXT_MISMATCH:はい、自然な結果を言う時に使います。 | candidate for delegated PASS after optional spot listen; keep native-speaker boundary in notes | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/1445c28c-bd0c-4c0a-b8f7-2708c51acca7/script-line-2.mp3) |
...
| MIXED_PROMPT_STT_UNRELIABLE | HN4-006 question:3 | 湖の深___を確認します。 (호수의 깊이를 확인합니다.) | 国の金を確認します。法成企ビルを確認します。 | 0.350 | TRANSCRIPTION_TEXT_MISMATCH:国の金を確認します。法成企ビルを確認します。 | listen for learner-facing completeness; do not treat STT mismatch alone as a fail | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/94d8d321-17c6-4fa1-8c50-af29c08e9c22/question-3.mp3) |
| MIXED_PROMPT_STT_UNRELIABLE | HN4-006 question:5 | '호수의 깊이를 확인했습니다'를 배열하세요. | ホスエエギピルル確認しましたを配列はせよ | 0.000 | TRANSCRIPTION_TEXT_MISMATCH:ホスエエギピルル確認しましたを配列はせよ | listen for learner-facing completeness; do not treat STT mismatch alone as a fail | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/94d8d321-17c6-4fa1-8c50-af29c08e9c22/question-5.mp3) |
