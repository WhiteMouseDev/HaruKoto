...
> Generated: 2026-05-20T07:38:35Z
> Status: PASS
...
| `tts_coverage` | PASS | 144/144 records; audio URL failures=0 |
| `audio_qa_verdicts` | PASS | 144/144 PASS; pending=0; flag=0; fail=0; invalid=0 |
...
- SCRIPT_LINE_TTS_RECORDS_READY: 64/64 records exist
- QUESTION_PROMPT_TTS_RECORDS_READY: 80/80 records exist
- PILOT_BATCH_TTS_RECORDS_READY: all expected script-line and question-prompt records exist
- AUDIO_URLS_READY: 144/144 checked URLs passed
