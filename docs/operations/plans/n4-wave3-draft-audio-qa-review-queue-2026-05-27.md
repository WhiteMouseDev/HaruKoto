...
> Status: REVIEW QUEUE - 8 pending rows remain
...
| P1 STT mismatch | HN4-019 question:4 | 들은 정보를 전달할 때 알맞은 표현은? |  | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/50d21797-c2c3-40ed-8641-db05efa0578d/question-4.mp3) | TRANSCRIPTION_FAILED:TimeoutError:, TRANSCRIPTION_TEXT_MISMATCH:聞いた情報を伝えるとき、適切な表現は | PENDING | `docs/operations/plans/n4-wave3-draft-human-audio-qa-ch05-2026-05-27.md` |
...
| P1 STT mismatch | HN4-020 script:2 | 挨拶は普通、先にするものです。 | 인사는 보통 먼저 하는 법입니다. | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/8d0b1638-2521-4556-964f-29023d1dbcef/script-line-2.mp3) | TRANSCRIPTION_FAILED:TimeoutError:, TRANSCRIPTION_TEXT_MISMATCH:挨拶は普通1000にするものです。 | PENDING | `docs/operations/plans/n4-wave3-draft-human-audio-qa-ch05-2026-05-27.md` |
...
| P3 resolved | HN4-020 question:3 | 約束は守る___です。 |  | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/8d0b1638-2521-4556-964f-29023d1dbcef/question-3.mp3) | TRANSCRIPTION_FAILED:TimeoutError:, TRANSCRIPTION_TEXT_MISMATCH:約束は守るならです | PASS | `docs/operations/plans/n4-wave3-draft-human-audio-qa-ch05-2026-05-27.md` |
...
| P3 resolved | HN4-021 question:3 | 席はある___です。 |  | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/92a62f1e-1a2f-4b54-897f-50ce13c2696a/question-3.mp3) | TRANSCRIPTION_FAILED:TimeoutError:, TRANSCRIPTION_TEXT_MISMATCH:かしわるーさに | PASS | `docs/operations/plans/n4-wave3-draft-human-audio-qa-ch05-2026-05-27.md` |
