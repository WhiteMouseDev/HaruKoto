...
> review approved; mobile happy-path and wrong-answer retry UAT passed; limited learner pilot approved
...
Result: the N4 pilot batch is structurally ready and has been applied to the current configured API DB target. Runtime API smoke verified N4 chapter/list/detail access and confirmed lesson-detail answer keys are redacted. The TTS manifest now tracks the official N4 lesson seed files directly. The review handoff is prepared at `docs/operations/plans/n4-pilot-human-review-handoff-2026-05-12.md`, and the user delegated curriculum approval to Codex because no human expert is currently available. All 10 rows are now `APPROVED` for target-runtime N4 mobile UAT. This is delegated AI curriculum approval, not native-speaker human approval. Target-runtime mobile happy-path and wrong-answer retry UAT passed on 2026-05-12. The learner rollout decision is now LIMITED GO for pilot learner exposure only; broad/full N4 rollout remains HOLD. See `docs/operations/plans/n4-pilot-learner-rollout-decision-2026-05-12.md`.
...
| Learner rollout decision | `docs/operations/plans/n4-pilot-learner-rollout-decision-2026-05-12.md` | LIMITED GO for controlled pilot exposure; broad/full N4 rollout remains HOLD |
...
11. LIMITED GO - Learner rollout decision is controlled pilot exposure only.
   The 10-lesson N4 pilot may remain available for internal, development, and limited beta learners. This does not approve broad marketing, a complete N4 course claim, native-speaker validation, or full batch TTS audio quality. See `docs/operations/plans/n4-pilot-learner-rollout-decision-2026-05-12.md`.
...
- [x] Learner rollout decision: LIMITED GO for controlled pilot exposure; broad/full N4 rollout remains HOLD.
