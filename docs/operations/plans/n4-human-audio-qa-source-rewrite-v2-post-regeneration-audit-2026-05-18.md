...
```bash
uv run python scripts/audit_n4_flag_post_regeneration_audio.py --review-csv ../../docs/operations/plans/n4-human-audio-qa-source-rewrite-v2-post-regeneration-review-2026-05-18.csv --regeneration-results-csv ../../docs/operations/plans/n4-human-audio-qa-source-rewrite-v2-current-db-results-2026-05-18.csv --transcribe --current-verdict FLAG --csv-output ../../docs/operations/plans/n4-human-audio-qa-source-rewrite-v2-post-regeneration-recommendations-2026-05-18.csv --markdown-output ../../docs/operations/plans/n4-human-audio-qa-source-rewrite-v2-post-regeneration-audit-2026-05-18.md
```

## Inputs

- Review CSV: `docs/operations/plans/n4-human-audio-qa-source-rewrite-v2-post-regeneration-review-2026-05-18.csv`
- Regeneration results CSV: `docs/operations/plans/n4-human-audio-qa-source-rewrite-v2-current-db-results-2026-05-18.csv`
...
| HN4-006 script:1 | この川の浅さも分かります。 | この川の浅さもわかります | TRANSCRIPTION_TEXT_MISMATCH:この川の浅さもわかります | FLAG | [audio](https://storage.googleapis.com/harukoto-storage/tts/lesson/94d8d321-17c6-4fa1-8c50-af29c08e9c22/script-line-1-regen-20260518T075845Z.mp3) |
