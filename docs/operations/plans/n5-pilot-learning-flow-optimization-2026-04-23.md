...
| 모바일 UAT 재실행 | 완료 | Lesson 2/3 실제 완료 플로우, 결과 화면 SRS 안내 위젯 계약, due item 기반 review CTA 실계정 진입과 `review_cta_clicked` 계측 PASS |
...
| review_cta_clicked | 확인 | `test1@test.com` N5 due item 5개 기준 복습 CTA 노출, 복습 퀴즈 진입, `jlptLevel`, `totalDue`, `wordDue`, `grammarDue`, `quizType` 속성 기록 |
