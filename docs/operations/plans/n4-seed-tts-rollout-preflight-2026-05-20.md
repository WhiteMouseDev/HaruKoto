...
> Generated: 2026-05-20T00:21:10Z
> Status: PASS
...
| `tts_coverage` | PASS | 99/99 records; audio URL failures=0 |
| `audio_qa_verdicts` | PASS | 99/99 PASS; pending=0; flag=0; fail=0; invalid=0 |
...
- AUDIO_URLS_READY: 99/99 checked URLs passed
