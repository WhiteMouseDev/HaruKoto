...
| Simulator launch precheck | PASS | iPhone 17 Pro simulator debug build launched and authenticated startup API calls returned 200; raw auth logs intentionally not recorded |
