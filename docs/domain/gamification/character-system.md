...
> **[마이그레이션 노트]** 캐릭터 해금 조건이 JLPT 레벨 기반(N4, N3, N2 등)에서 XP/레벨 기반으로 변경되었습니다. 기존에는 사용자의 JLPT 목표 레벨에 따라 캐릭터가 해금되었으나, 현재는 앱 내 XP 획득을 통한 레벨업으로 해금됩니다. (`XP_SYSTEM.md` 참조)
...
| 리코: `unlockCondition: 'N3'` | 카이토: `'3'` (레벨 3) | JLPT 기반 → XP 레벨 기반 마이그레이션 |
